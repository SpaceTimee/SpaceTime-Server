/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/wrangler.toml workers/worker-configuration.d.ts` (hash: 7a595cb5a424e69bc5f0fd17a48f10b1)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "CensorSession";
	}
